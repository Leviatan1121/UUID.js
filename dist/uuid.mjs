class UUID {
    ...
    generate(uuid = this.last_uuid, reuse = null) {
        ...
        if (uuid === null && reuse === false) {
            console.log('TRY');

            console.log(reuse && this.unused_uuids_count > 0);
            console.log(reuse === null && this.reuse_by_default && this.unused_uuids_count > 0);
            ...
            console.log(reuse);
            console.log(this.reuse_by_default);
            console.log(this.unused_uuids_count);
        }
        ...
        } else if (!uuid || uuid !== null) { //! TODO: Check this condition
            console.log('B');
